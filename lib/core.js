...
function Promise(fn) {
  ...
  function internalHandle(deferred) {
    ...
    asap(function(fulfilled, ignored, value) {
      if(ignored){
        deferred.cancel();
        return
      }
      var cb = fulfilled ? deferred.onFulfilled : deferred.onRejected
      if (cb === null) {
        (fulfilled ? deferred.resolve : deferred.reject)(value)
        return
      }
      var ret
      try {
    ...
    }.bind(null, state === FULFILLED, state === IGNORED, value));
  }
